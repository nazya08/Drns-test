...
class Inventory(models.Model):
    ...
    product = models.ForeignKey(
        DronePart, on_delete=models.SET_NULL, null=True, related_name='inventory_items', verbose_name='Product'
    )
    ...
    # safety_stock може бути використане для попередження про нестачу товару або для управління запасами.
